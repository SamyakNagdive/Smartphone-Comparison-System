    ...
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="./?page=mobiles/manage_mobile&id=<?= isset($id) ? $id : '' ?>" class="btn btn-sm btn-flat btn-primary"><i class="fa fa-edit"></i> Edit Details</a>
                <button id="delete_mobile" class="btn btn-sm btn-flat btn-danger"><i class="fa fa-trash"></i> Delete Data</button>
            </div>
        </div>
        <div class="card-body">
