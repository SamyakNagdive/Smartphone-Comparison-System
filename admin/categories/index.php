...
<div class="card card-outline rounded-0 card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="manage_order" class="btn btn-flat btn-sm btn-navy border"><span class="fas fa-stream"></span>  Update Order</a>
        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * from `category_list` where delete_flag = 0  order by order_by asc,`name` asc ");
...
<script>
	$(document).ready(function(){
		...
		$('#manage_order').click(function(){
			uni_modal("<i class='fa fa-strem'></i> Manage Category Order","categories/manage_order.php")
		})
		$('.view_data').click(function(){
			uni_modal("<i class='fa fa-eye'></i> Category Details","categories/view_category.php?id="+$(this).attr('data-id'))
		})
